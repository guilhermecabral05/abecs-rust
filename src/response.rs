...
impl AbecsResponse {
    ...
    pub fn status_description(&self) -> &str {
        match self.status.as_str() {
            "000" => "Sucesso",
            "003" => "Comunicação Segura não estabelecida",
            "004" => "Tecla F1 pressionada",
            "005" => "Tecla F2 pressionada",
            "006" => "Tecla F3 pressionada",
            "007" => "Tecla F4 pressionada",
            "008" => "Tecla backspace pressionada",
            "009" => "Erro de decodificação ou pacote em claro",
            "010" => "Chamada inválida ou comando desconhecido",
            "011" => "Parâmetro inválido",
            "012" => "Timeout esgotado",
            "013" => "Operação cancelada pelo usuário",
            "019" => "Parâmetro mandatório ausente",
            "020" => "Versão das Tabelas EMV diferente",
            "021" => "Erro ao gravar tabelas",
            "040" => "Erro interno do pinpad",
            "041" => "Erro de leitura do cartão magnético",
            "042" => "Chave MK/DUKPT não presente",
            "043" => "ICC ou CTLS ausente",
            "044" => "Pinpad ocupado (limite de capturas PIN)",
            "045" => "Resposta muito grande",
            "046" => "Erro de validação criptográfica",
            "051" => "SAM ausente ou com erro",
            "060" => "ICC ausente ou não responde",
            "061" => "Erro de comunicação com ICC/CTLS",
            "067" => "Cartão invalidado",
            "068" => "ICC com problemas",
            "069" => "ICC com dados inválidos",
            "070" => "ICC sem aplicação disponível",
            "071" => "Aplicação ICC não autorizada",
            "076" => "Erro passível de fallback",
            "077" => "Valor inválido",
            "078" => "Muitos AIDs candidatos",
            "079" => "Cartão bloqueado",
            "080" => "Múltiplos CTLS detectados",
            "081" => "Erro de comunicação CTLS",
            "082" => "CTLS invalidado",
            "083" => "CTLS com problemas",
            "084" => "CTLS sem aplicação disponível",
            "085" => "Aplicação CTLS não autorizada",
            "086" => "CVM externo requerido",
            "087" => "Mudança de interface solicitada",
            "100" => "Arquivo multimídia não encontrado",
            "101" => "Erro no formato do arquivo multimídia",
            "102" => "Erro na carga do arquivo multimídia",
